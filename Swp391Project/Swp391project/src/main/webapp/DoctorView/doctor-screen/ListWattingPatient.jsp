            ...
            <div class="main-view main-view-content">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <c:forEach items="${listWattingPatient}" var="c">
                            <tr>
                                <th><% count++;
                                    out.print(count);%></th>
                                ...
                                <th><a href="ReportError?Idcard=${c.getIdcard()}" style="color: black " onclick="return confirm('Would you like to continue reporting this patient?')">Error</a></th>
                            </tr>
                        </c:forEach>
