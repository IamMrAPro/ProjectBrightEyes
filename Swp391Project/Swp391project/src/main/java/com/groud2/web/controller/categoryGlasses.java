 ...
 * @author anhha
 */
public class categoryGlasses extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet categoryGlasses</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet categoryGlasses at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        String gender = request.getParameter("categoryname");
        ...
        try {
            ArrayList<glasses> list =g.getAllglasses(pageid,total,gender);
