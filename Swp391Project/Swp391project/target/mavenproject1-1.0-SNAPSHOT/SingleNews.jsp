    ...
    <body>
        ...
        <c:forEach items="${SingleNews}" var="item">                       
            ...
            <div class="col-md-12 animate-box" data-animate-effect="fadeInLeft">
                ...
                <br> <div style="margin-left: 400px;margin-right:  400px"><img src="assets/images/news/${item.getImages1()}" style="width: 700px;height: 400px" alt="alt"/> </div>                             
                ...
                <br> <div style="margin-left: 400px;margin-right:  400px"><img src="assets/images/news/${item.getImages2()}" style="width: 700px;height: 400px" alt="alt"/> </div>                             
                ...
                <br> <div style="margin-left: 400px;margin-right:  400px"><img src="assets/images/news/${item.getImages3()}" style="width: 700px;height: 400px" alt="alt"/> </div>                             
                ...
                <br> <div style="margin-left: 400px;margin-right:  400px"><img src="assets/images/news/${item.getImages4()}" style="width: 700px;height: 400px" alt="alt"/> </div>                             
