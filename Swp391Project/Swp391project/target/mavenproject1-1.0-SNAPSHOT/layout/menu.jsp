...
<nav class="navbar navbar-expand-lg bg-light shadow-lg">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item ">
                <a style="font-size: 30px" class="nav-link click-scroll" href="cart"><ion-icon name="cart-outline"></ion-icon></a>
            </li>
            ...
            <c:if test="${sessionScope.id != null}">
                <li class="nav-item ">
                    <a class="nav-link click-scroll" href=""><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
    ...
    <div class="navbar-nav book " style="background-color: pink;">
        <a class="nav-link text-center"  href="booking"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-calendar-event" viewBox="0 0 16 16">
