...
<html>
    ...
    <body>
        ...
        <div class="limiter" >
            <form class="login100-form validate-form" action="recordOnline" method="post">
                    ...
                    <div class=" col-md-6">
                        ...
                        <div style="display: flex; justify-content: space-between">
                           <div class=" validate-input m-b-13" data-validate="Phone is required">                         
                               Phone <input class="input100" type="text" name="phone" value="${ld.getPhone()}" placeholder="Type your Phone" minlength="10" maxlength="10">                            
                            </div>
                            
                           
                            <div class=" validate-input m-b-13" data-validate="Email is required">                         
                                Email <input  class="input100" type="text" name="email" value="${ld.getEmail()}" placeholder="Type your Email">  
